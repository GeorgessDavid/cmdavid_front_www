        ...
        <header>
            ...
            {alertVisible &&
                <Alert severity="warning" style={{ position: 'fixed', top: '14vh', left: '15vw', zIndex: 1000, maxWidth: '70%', margin: '0 auto' }} >
                    🏥 <strong>Importante:</strong> A partir del <strong>Lunes 5 de Enero de 2026</strong>, Consultorios Médicos David se traslada a <strong>Padre Silberman 1346, Santos Lugares</strong>. ¡Los esperamos en nuestra nueva <a href="https://maps.app.goo.gl/LLXuZfKs39o8zbZJ7" target="_blank" rel="noopener noreferrer">ubicación</a>!
                </Alert>
            }
        </header>
    )
