...
import { Facebook, Instagram, LinkedIn, WhatsApp, Mail } from "@/constants/links";
        ...
        <div>
            <IconButton onClick={handleOpen}>
                ...
                <DrawerBody>
                    ...
                    <Divider sx={{
                        backgroundColor: resolvedTheme === 'dark' ? '#ffffff' : '#101219', opacity: 0.2
                    }} variant='middle' />
                    <List>
                        <ListItem>
                ...
                <DrawerFooter>
                    <div className='flex items-center gap-2'>
                        <Link href={Instagram} target='_blank'><InstagramIcon sx={[{ color: resolvedTheme === 'dark' ? '#ffffff' : '#034d37', margin: "0 0.5rem", fontSize: "2rem" }]} /></Link>
                        <Link href={Facebook} target='_blank'><FacebookIcon sx={[{ color: resolvedTheme === 'dark' ? '#ffffff' : '#034d37', margin: "0 0.5rem", fontSize: "2rem" }]} /></Link>
                        <Link href={WhatsApp} target='_blank'><WhatsAppIcon sx={[{ color: resolvedTheme === 'dark' ? '#ffffff' : '#034d37', margin: "0 0.5rem", fontSize: "2rem" }]} /></Link>
                        <Link href={LinkedIn} target='_blank'><LinkedInIcon sx={[{ color: resolvedTheme === 'dark' ? '#ffffff' : '#034d37', margin: "0 0.5rem", fontSize: "2rem" }]} /></Link>
                    </div>
                </DrawerFooter>
            </Drawer>
        </div>
