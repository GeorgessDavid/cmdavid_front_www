export const WhatsApp = 'https://wa.me/5491135958787';
export const Prestadores = 'https://app.consultoriosmedicosdavid.com.ar';
export const Facebook = 'https://www.facebook.com/ConsultoriosMedicosDavid';
